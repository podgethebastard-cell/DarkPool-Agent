...
st.markdown(
    """
**Institutional-grade screening** across **Global / Russell / UK / Euro / Junior Miners**  
with **regime-adaptive quant scoring**, **Telegram signals**, an **interactive AI analyst**,  
and a **portfolio builder (equal weight / inverse vol / risk parity)**.
"""
)
st.caption("Educational tool. Not investment advice. Data quality varies by ticker.")
...
def fetch_fundamentals(ticker: str) -> dict:
    try:
        ...
        return {
            ...
            "revenue_growth": float(info.get("revenueGrowth") or np.nan),
        ...
        return {
            ...
            "revenue_growth": np.nan, "debt_to_equity": np.nan, "industry": "Unknown", "sector": "Unknown",
            "name": ticker, "country": "Unknown"
        }
