...
# ... (Keep all your existing code above this line) ...
    ...
    # 7. LEGAL DISCLAIMER (Add this at the very bottom)
    st.markdown("---")
    with st.expander("⚠️ Disclaimer & Risk Warning"):
        st.markdown("""
        **For Research Purposes Only.**
        This application is a beta prototype powered by Artificial Intelligence. It is designed for technical analysis experimentation and **does not constitute financial advice**, investment recommendations, or trading signals.
        
        * **AI Limitations:** The "Expert Verdict" is generated by GPT-4 based on mathematical patterns. AI can hallucinate, misinterpret data, or fail to predict market shocks.
        * **No Guarantees:** Past performance of indicators (Apex, Squeeze, Money Flow) does not guarantee future results.
        * **High Risk:** Trading assets like Bitcoin and Derivatives involves a substantial risk of loss. You could lose your entire investment.
        * **Data:** Market data is provided by third-party sources (Yahoo Finance) and may be delayed or inaccurate.
